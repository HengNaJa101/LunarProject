...
**Important:** แก้ไขรหัสผ่าน PostgreSQL ก่อนใช้งาน

### วิธีที่ 1: ใช้ Script (แนะนำ)
```bash
# Linux/Mac
./update_password.sh your-actual-password

# Windows
update_password.bat your-actual-password
```

### วิธีที่ 2: แก้ไขเอง
แก้ไขการตั้งค่าใน `api.py`, `api_safe.py`:
```python
DATABASE_CONFIG = {
    'host': 'localhost',
    'password': 'your-actual-password'  # เปลี่ยนตามรหัสผ่านจริง
}
```